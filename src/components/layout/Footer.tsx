...
const links = {
  ...
  company: [
    ...
    { label: "Contact", href: "mailto:hello@moveapt.com" },
  ],
  social: [
    {
      label: "Twitter / X",
      href: "https://twitter.com/moveapt",
      icon: (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-xs text-slate-600">
            © {new Date().getFullYear()} moveAPT. All rights reserved.
          </p>
          <p className="text-xs text-slate-700">
            Made with ❤️ by renters who lost $400 on a couch.
          </p>
        </div>
      </div>
    </footer>
